...
public class MilogConfigController {
    ...
    public Result<String> newLogSpace(MilogSpaceParam cmd) {
        return logSpaceService.newMilogSpace(cmd);
    }

    @RequestMapping(path = "/milog/space/getbyid", method = "get")
    public Result<MilogSpaceDTO> getLogSpaceById(@RequestParam("id") Long id) {
        return logSpaceService.getMilogSpaceById(id);
    }

    @RequestMapping(path = "/milog/space/getall", method = "get")
    public Result<List<MapDTO<String, Long>>> getLogSpaces() {
        return logSpaceService.getMilogSpaces();
    }

    @RequestMapping(path = "/milog/space/getbypage", method = "get")
    public Result<PageInfo<MilogSpaceDTO>> getLogSpaceByPage(MvcContext context, @RequestParam(value = "spaceName") String spaceName,
    ...
    public Result<String> deleteLogSpace(@RequestParam("id") Long id) {
        return logSpaceService.deleteMilogSpace(id);
    }

    @RequestMapping(path = "/milog/space/update")
    public Result<String> updateLogSpace(@RequestParam("param") MilogSpaceParam param) {
